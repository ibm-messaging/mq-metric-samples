...
# amqsevt="./amqsevt -e localhost:4317 -i " # An OTel output path
# amqsevt="./amqsevt -e stdout" # An OTel output path
amqsevt="./amqsevt" # The default processing with JSON output
